		...
		<div class="login-form">
			<form action="#" method="post" class="px-3 pt-3 pb-0">
				<div class="form-group">
					<label for="recipient-name" class="col-form-label">User Name/Email Id/Phone No</label>
					<input type="email" class="form-control" placeholder="User Name or Email Id or Phone No" name="Name" id="recipient-name" required="">
				</div>
				<div class="form-group">
